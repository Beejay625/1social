...
const abTests = [
  {
    ...
    status: "running",
    variantA: { label: "Blue CTA", conversion: 3.2 },
    variantB: { label: "Green CTA", conversion: 4.1 },
    winner: "B",
    confidence: 87,
  },
  {
    ...
    status: "completed",
    variantA: { label: "Question format", conversion: 2.8 },
    variantB: { label: "Statement format", conversion: 3.5 },
    winner: "B",
    confidence: 92,
  },
];
...
const contentTemplates = [
  {
    ...
    description: "Multi-channel launch template with CTA and visual assets",
    usage: 24,
  },
  {
    id: "template-2",
    ...
    description: "Highlight community wins with engagement hooks",
    usage: 18,
  },
  {
    id: "template-3",
    ...
    description: "BTS content template optimized for engagement",
    usage: 31,
  },
];
...
const workflowAutomations = [
  {
    ...
    condition: "No mentions, < 500 chars",
    action: "Auto-approve",
    status: "active",
    executions: 12,
  },
  ...
  {
    id: "auto-3",
    name: "Auto-post high-performing content",
    trigger: "Post performance",
    condition: "Engagement > 8% for 24h",
    action: "Cross-post to other channels",
    status: "paused",
    executions: 0,
  },
];
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/15 bg-white/5 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-semibold text-emer